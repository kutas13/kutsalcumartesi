...
export const userConfig={
  Yusuf:{role:'admin',password:process.env.KCK_YUSUF_PASSWORD},
  'Ömer':{role:'viewer',password:process.env.KCK_OMER_PASSWORD},
  Taha:{role:'viewer',password:process.env.KCK_TAHA_PASSWORD}
};
...
export function verifyPassword(user,password){return !!userConfig[user]?.password&&safeEq(userConfig[user].password,password)}
